...
namespace Lab8_1_
{
    public class ResourseDepartment
    {
        ...
        {
            Console.WriteLine("{0, -5} {1, -28} {2, -10} {3, -10} {4}", "ID", "Прізвище, імя, по-батькові", "Посада", "Зарплата", "Дата прийняття на роботу");
        ...
        public void addNew()
        {
            Console.WriteLine("Введiть данi через кому:( ID, Прізвище, імя, по - батькові, Посада, Зарплата, Дата прийняття на роботу)");
            try
            {
        ...
        public void edit()
        {
            ...
            try
            {
                ...
                foreach (Employee emp in employees)
                {
                    ...
                    {
                        emp.showInfo();
                        Console.WriteLine("Введіть нову інформацію через кому( ID, Прізвище, імя, по - батькові, Посада, Зарплата, Дата прийняття на роботу)");
                        string strInfo = Console.ReadLine();
